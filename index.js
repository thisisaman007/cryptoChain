...
app.post('/api/transact', (req, res) => {
    ...
    pubsub.broadcastTransaction(transaction);//broadcast the transaction to all instances/nodes
...
// frontend ffffffffffffffffffffffffffffffffffffffffff
...
//helper methods to conduct dummy transactions
